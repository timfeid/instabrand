...
CREATE TABLE "order_variants" (
    ...
    CONSTRAINT "order_variants_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "variants_is_default_product_id_key" ON "variants"("is_default", "product_id");
...
-- AddForeignKey
ALTER TABLE "order_variants" ADD CONSTRAINT "order_variants_price_id_fkey" FOREIGN KEY ("price_id") REFERENCES "variants"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "order_variants" ADD CONSTRAINT "order_variants_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
